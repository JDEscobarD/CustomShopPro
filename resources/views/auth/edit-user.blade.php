                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('departamento_id') is-invalid @enderror" id="departamentos" name="departamento_id" required>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('ciudad_id') is-invalid @enderror" id="ciudades" name="ciudad_id" required>
                                    @foreach ($ciudades as $ciudad)
                                    <option value="{{ $ciudad->id }}" {{ $user->ciudad_id == $ciudad->id ? 'selected' : '' }}>
                                        {{ $ciudad->nombre }}
                                    </option>
                                    @endforeach
                                </select>
